...
# MFD-Ping documentation build configuration file, created by
...
htmlhelp_basename = "mfd-ping-doc"
...
latex_documents = [
    (master_doc, "mfd-ping.tex", "MFD-Ping Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-ping", "MFD-Ping Documentation", [author], 1)]
